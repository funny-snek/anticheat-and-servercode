...
namespace anticheatviachat
{
    ...
    class Server_sendMessage_Patcher : Patch.Patch
    {
    ...
    class Multiplayer_processIncomingMessage_Patcher : Patch.Patch
    {
    ...
    class parseServerToClientsMessage_Patcher : Patch.Patch  //this totally works!
    {
        ...
        {
            if (message.Substring(0, 4) == "SCAL")//currentpass
            {
    ...
    public class ModEntry : Mod
    {
        ...
        public override void Entry(IModHelper helper)
        {
            Patch.Patch.PatchAll("anticheatviachat.anticheatviachat");
            GameEvents.OneSecondTick += this.GameEvents_OneSecondTick;
            GameEvents.FourthUpdateTick += this.GameEvents_FourthUpdateTick;
